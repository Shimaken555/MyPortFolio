  ...
  <SAboutMain>
    <SABoutLeft>
      ...
      <SABoutRight>
        <SABoutProfile>
          名称：ShimaKen<br/>
          スキル：HTML、CSS、Bootstrap、Javascript、PHP<br/>
          所在地：東京都<br/>
          趣味：謎解きゲーム、ポケモン、スピッツ、カフェ巡り<br/>
        </SABoutProfile>
      <SABoutHistory>
          埼玉県出身。1988年生まれ。<br/>
          上智大学理工学部数学科卒業。<br/>
          2011年に物流会社に入社。医薬品配送センターの業務を経て、2016年より情報システム課(社内SE)で勤務。<br/>
          情報システム課として、今まで多くの社内ユーザーの問題解決を行っていく中で、要件定義・テスト・保守だけではなく、自分の手でWebサービスを作成したい、自分が作成したサービスでより多くの人に幸せを提供できる仕事がしたい、という気持ちが強くなりました。<br/>
          自分で書いたコードがWeb画面上で形になっていく過程が楽しいという理由と、お客様との距離が近いという2つの理由でWeb制作のエンジニアに魅力を感じました。仕事の傍ら、平日3時間、休日7時間の学習を150日間以上継続してます！<br/>
      </SABoutHistory>
    </SABoutRight>
  </SAboutMain>
